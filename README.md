...
Data Layer: Processes raw CSV data into a User-Item interaction matrix.

Modeling Layer:

NCF: A Multi-Layer Perceptron (MLP) architecture that learns non-linear relationships between users and services.

TF-IDF: Analyzes synthetic service descriptions to find logical service groupings.

Application Layer: Streamlit UI that allows stakeholders to input a Customer ID and view ranked recommendations.
